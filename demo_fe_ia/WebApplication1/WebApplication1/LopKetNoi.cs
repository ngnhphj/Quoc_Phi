...
namespace WebApplication1
{
    public class LopKetNoi
    {
        ...
        {
            string SqlCon = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\trana\Documents\GitHub\Quoc_Phi\demo_fe_ia\WebApplication1\WebApplication1\App_Data\Database1.mdf;Integrated Security=True";
